...
function DropdownMenuItem({
  ...
  const handleSelect = (event: Event) => {
    // Remove scroll lock when item is selected
    if (document.documentElement.classList.contains('scroll-locked')) {
      document.documentElement.classList.remove('scroll-locked');
    }
...
function DropdownMenuSubTrigger({
  ...
  return (
    <DropdownMenuPrimitive.SubTrigger
      ...
      data-inset={inset}
      className={cn(
        'focus:bg-accent focus:text-accent-foreground data-[state=open]:bg-accent data-[state=open]:text-accent-foreground flex cursor-default cursor-pointer items-center rounded-sm px-2 py-1.5 text-sm outline-hidden select-none data-[inset]:pl-8',
        className
      )}
      {...props}
    >
